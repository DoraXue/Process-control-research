function [Kf, Km, Kdelta] = Lipschitz_Constants(Za, beta, z, Zstep)
% Za = pi/2;
% beta = 2;

% 2017-02-20
% Find Liptchiz constants Km, Kf, Kdelta
...
% mu_b = 1;                     % half-width of finite support
...
for i = 1:NumA
    ...
    damodel = NonlinearFunction(Ainf,a(i),gamma,betaT,Phi_model,X,Zstep);
...
for i = 1:NumA-1
%    Dda(i) = da(i+1) - da(i);
%    Ddeltaf(i) = deltaf(i+1) - deltaf(i);
%    Dga(i) = ga(i+1) - ga(i);
%    Ddeltag(i) = deltag(i+1) - deltag(i);
